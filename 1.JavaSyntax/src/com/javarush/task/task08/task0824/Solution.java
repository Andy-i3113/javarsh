...
public class Solution {
    public static void main(String[] args) {
        ...
        Human child1 = new Human("Ребенок1",true, 5,new ArrayList<>());
        Human child2 = new Human("Ребенок2",false, 14,new ArrayList<>());
        Human child3 = new Human("Ребенок3",false, 13,new ArrayList<>());
